...
const competitionAreas = [
  {
    ...
    description:
      'Graphs, sorting, searching, recursion, dynamic programming, and efficient data structures.'
  },
  {
    name: 'UIL Computer Science',
    description:
      'Java, code tracing, language rules, written tests, hands-on programming, and team strategy.'
  },
  {
    name: 'Contest training',
    description:
      'Timed problem sets, solution reviews, and practice focused on speed, clarity, and correctness.'
  },
  {
    name: 'Mock meets & hackathons',
    description:
      'Occasional events for longer problems, team competition, and building beyond a weekly lesson.'
  }
];
...
export default function ClubTracksSection () {
  return (
    <section
      className='section-shell tracks-section'
      id='tracks'
      ...
      <div className='section-inner tracks-layout'>
        <div className='logic-lab' data-sort-lab>
          <div className='logic-lab-head'>
            ...
            >
              ...
              <span className='sr-only'>
                Replay the insertion sort animation
              </span>
            </button>
          </div>
          ...
          <div className='logic-lab-foot'>
            <p className='logic-lab-status' id='sort-status' aria-live='polite'>
              Ready / starts when in view
            </p>
        ...
        <div className='tracks-copy'>
          <h2 className='section-heading' id='tracks-heading'>
            <span>Inside competitive</span> <span>programming.</span>
          </h2>
          <p className='section-intro'>
            Practice algorithms, Java, and code tracing for programming contests
            and UIL Computer Science.
          </p>
