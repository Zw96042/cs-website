...
export default function EventsPreviewSection () {
  ...
  return (
    <section
      className='section-shell event-preview-section'
      id='events'
    ...
    >
      <div className='section-inner event-preview-layout'>
        <header className='event-preview-heading'>
          <h2 className='section-heading' id='event-preview-heading'>
            Upcoming events.
          </h2>
        ...
        <div className='event-ledger event-preview-ledger'>
          {upcomingEvents.map((event) => (
            <article
              className='event-ledger-item event-preview-item'
            ...
            >
              ...
              <div className='event-details'>
                ...
                <p className='event-description'>
                  {event.location && (
                    <strong className='event-location'>{event.location}</strong>
                  )}
                  {event.description}
                </p>
              </div>
